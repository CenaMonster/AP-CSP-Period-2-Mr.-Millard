...
MARTIALHERO_SIZE = 162
MARTIALHERO_SCALE = 3
MARTIALHERO_OFFSET = [105, 82]
MARTIALHERO_DATA = [MARTIALHERO_SIZE, MARTIALHERO_SCALE, MARTIALHERO_OFFSET]
MARTIALHERO2_SIZE = 162
MARTIALHERO2_SCALE = 3
MARTIALHERO2_OFFSET = [34, 88]
...
martialhero_sheet = pygame.image.load("Martial Hero/Sprites/Martial Hero.png").convert_alpha()  #loads spritesheets
martialhero2_sheet = pygame.image.load("Martial Hero 2/Sprites/Martial Hero 2.png").convert_alpha()
